...
#elif versionGS4Mv11RD
    #include "RTree_723oct21s_stochastic_21Sep23_GS4Mv11R_deletion.h"
    ...
    // for(int i = 0; i < 2; i++){
        ...
        if(i % ratio == 0 && i != 0){
            for(int o =0; o < insert_count; o++){
                ...
                // #elif versionCQGS3
                //     tree.Insert_gradual(min, max, this_id);
               #if defined(versionGS) || defined(versionGS2) || defined(versionGS3) || defined(versionGS4) || defined(versionGS4M) || defined(versionGS4Mv11) || defined(versionGS4Mv11R) || defined(versionGS4Mv11RD) || defined(versionGS4Mv11RP) || defined(versionGS4Mv11RS) || defined(versionGS4Mv11RSR) || defined(versionGS4Mv11RSRC) || defined(versionGS4Mv11RSRP) || defined(versionGS3M)  || defined(versionGSTerminal) || defined(versionGSL) || defined(versionGSTSpecial) || defined(CQGS) || defined(CQGS2) || defined(CQGS3)
                    tree.Insert_gradual(min, max, this_id);
            ...
            for(int o =0; o < delete_count; o++){
                ...
                #if defined(versionGS4Mv11RD)
                    // if(tbd_ids[how_many_deleted_till_now] == 4338016){
                    //     cout << "deleting 4338016..." << endl; 
                    // }
                    // item_index_to_be_deleted_choice = (rand() % data.size());
                    start_delete_time = clock();
                    // cout << "deleting item " << item_index_to_be_deleted_choice << "  with id: " << data_ids[item_index_to_be_deleted_choice] <<  " with rect: " << data[item_index_to_be_deleted_choice].m_min[0] << " " << data[item_index_to_be_deleted_choice].m_max[0] << " " << data[item_index_to_be_deleted_choice].m_min[1] << " " << data[item_index_to_be_deleted_choice].m_max[1] << endl;
                    // tree.Delete(data[item_index_to_be_deleted_choice].m_min, data[item_index_to_be_deleted_choice].m_max, data_ids[item_index_to_be_deleted_choice]);
                    ...
                    // cerr << data[item_index_to_be_deleted_choice].m_min[0] << " " << data[item_index_to_be_deleted_choice].m_min[1] << " " << data[item_index_to_be_deleted_choice].m_max[0] << " " << data[item_index_to_be_deleted_choice].m_max[1] << " " << data_ids[item_index_to_be_deleted_choice] << endl;
                    delete_time += clock() - start_delete_time;
                    how_many_deleted_till_now++;
                    // data.erase(data.begin() + item_index_to_be_deleted_choice);
                    // data_ids.erase(data_ids.begin() + item_index_to_be_deleted_choice);
                #endif
            }
        ...
        // tree.findDataInAllPlaces(4423043);
        ...
        // #elif versionCS2
        //     found_count = tree.QueryAdaptive_v15(queries[i].m_min, queries[i].m_max);
         #if defined(versionGS) || defined(versionGS2) || defined(versionGS3) || defined(versionGS4) || defined(versionGS4M) || defined(versionGS4Mv11) || defined(versionGS4Mv11R)|| defined(versionGS4Mv11RD) || defined(versionGS4Mv11RP) || defined(versionGS4Mv11RS) || defined(versionGS4Mv11RSRC) || defined(versionGS4Mv11RSR) || defined(versionGS4Mv11RSRP) || defined(versionGS3M) || defined(versionGSTerminal) || defined(versionGSL) || defined(versionGSTSpecial) || defined(versionCS) || defined(versionCSR) || defined(versionCS2) || defined(versionCSv11) || defined(versionCS2R) || defined(versionCS2RC) || defined(versionCS2RM) || defined(versionCS2RP)
            found_count = tree.QueryAdaptive_v15(queries[i].m_min, queries[i].m_max);
 ...
 //               fill_holes_count = 0;
  //              split_leaf_count = 0;
	...
	cout << found_count << endl;
        ...
        //     tree.printLeafLinkedList();
        // if(i == 3699){
        //     cout << "looking for 4338016..." << endl;
        //     tree.printLeafBoundsOfData(4338016);
        // }
